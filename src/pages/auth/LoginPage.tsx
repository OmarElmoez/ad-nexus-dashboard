...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // If login successful, the auth store will set isAuthenticated to true
    // and the PrivateRoute component will take care of redirecting to the dashboard
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden md:flex md:w-1/2 bg-cover bg-center relative overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?auto=format&fit=crop&q=80&w=1080" 
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-brand-purple/80 to-transparent flex items-center">
          <div className="px-8 md:px-16 text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Welcome Back to AdNexus</h1>
            <p className="text-xl opacity-90 mb-8">
              Access your campaign dashboard and take control of your marketing strategies.
            </p>
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <p>Manage all campaigns in one place</p>
              </div>
              <div className="flex items-center space-x-2">
                <div className="bg-white/20 p-2 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 13l4 4L19 7"/></svg>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/forgot-password" className="text-sm font-medium text-brand-purple hover:text-brand-dark-purple">
                      Forgot password?
                    </Link>
                  </div>
                  <Input
